...
import { ModalSalesDetailsProps } from "./types";

import { useButtonModalSales } from "./useButtonModalSales";
...
export default function ModalSalesDetails({
  ...
  const { getTotalPrice } = useButtonModalSales();

  const totalPrice = getTotalPrice(listProducts);
